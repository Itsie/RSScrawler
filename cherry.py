...
<html>
  ...
  <div class="container">
    ...
    <form id="rsscrawler" enctype="multipart/form-data" method="post" action="speichern">
          ...
          3D-Releases suchen:<div hinweis="Wenn aktiviert, sucht das Script zusätzlich auch nach 3D Releases (in 1080p), unabhängig von der oben gesetzten Auflösung."><input type="text" name="crawl3d" value="''' + crawl3d +'''"></div>
